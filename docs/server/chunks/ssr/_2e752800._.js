...
const ArticleDetailPage = ({ params })=>{
    ...
    const article = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$article$2f$data$2f$articles$2d$content$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getArticle"])(id);
    if (!article) {
    ...
    // 아티클 콘텐츠 가져오기
    const content = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$article$2f$data$2f$articles$2d$content$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getArticleContent"])(id);
