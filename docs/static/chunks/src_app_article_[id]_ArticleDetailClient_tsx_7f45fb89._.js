...
"[project]/src/app/article/[id]/ArticleDetailClient.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
const processMarkdown = async (content1)=>{
    const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$remark$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["remark"])().use(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$remark$2d$html$2f$lib$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"]).process(content1);
...
function ArticleDetailClient(param) {
    let { article, content: content1 } = param;
    _s();
    ...
    const formatContent = (content1)=>{
        ...
        for(let i = 0; i < lines.length; i++){
            ...
            if (line.startsWith('# ')) {
                ...
                elements.push(/*#__PURE__*/ _jsxDEV("br", {}, "br-".concat(currentIndex++), false, {
                    fileName: "[project]/src/app/article/[id]/ArticleDetailClient.tsx",
                    lineNumber: 125,
                    columnNumber: 23
                }, this));
...
_s(ArticleDetailClient, "hXgDRvR8L9itXdQDKIB9Bab/ptE=");
...
//# sourceMappingURL=src_app_article_%5Bid%5D_ArticleDetailClient_tsx_7f45fb89._.js.map